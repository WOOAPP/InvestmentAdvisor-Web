      ...
      <nav className="bg-[var(--bg2)] border-b border-[var(--gray)] flex-shrink-0">
        ...
        <div className="flex items-center justify-between px-4 md:px-6 py-2.5 md:py-3">
          <div className="flex items-center gap-4 md:gap-8">
            ...
            <Link to="/" className="flex items-center gap-1.5" onClick={(e) => { closeMenu(); if (location.pathname === '/') e.preventDefault(); }}>
              <img src="/logo.png" alt="IAdvisor" className="h-12 md:h-[84px]" />
              <span className="text-[var(--overlay)] text-[7px] md:text-xs tracking-wide whitespace-nowrap">by R.Dębski inc.</span>
            </Link>
